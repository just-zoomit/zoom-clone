  ...
  console.log("date", date);
    ...
    return (
        ...
        <StyledForm onSubmit={handleSubmit}>
            ...
            <StyledInput type="text" value={formData.topic} onChange={(e) => changeData({ topic: e.target.value })}/>

            <StyledLabel > Date & Time :</StyledLabel>

    
            <StyledInput type="datetime-local" value={formData.start_time} onChange={(e) =>
                        changeData({ start_time: e.target.value })
                      } />

            <StyledButton type="submit" onClick={updateData}> Update Data</StyledButton>
            &nbsp;
            <StyledButton type="submit" onClick={resetData}> Reset Data</StyledButton>
            &nbsp;
            <StyledButton type="submit" onClick={deleteData}>Delete Data</StyledButton>
